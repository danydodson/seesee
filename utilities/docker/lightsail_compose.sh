...
mkdir /srv/seesee
git clone https://github.com/danydodson/seesee /srv/seesee/
...
cp /srv/seesee/utilities/docker/service.service /etc/systemd/system/docker-compose-app.service
systemctl enable docker-compose-app

# start up the application via docker-compose
docker-compose -f /srv/seesee/docker-compose.yml up -d
